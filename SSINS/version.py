"""
Copied from pyuvdata.version with permission from Bryna Hazelton.
"""
...
SSINS_dir = os.path.dirname(os.path.realpath(__file__))
...
def construct_version_info():
    ...
    version_file = os.path.join(SSINS_dir, 'VERSION')
